    ...
    return;
	    ...
	    if (networkState == Connection.NONE) {
	        ...
	        window.imageResizer.resizeImage(
				...
				deviceWidth,
				deviceHeight,
				{imageData:'urlImage', quality: 100, storeImage: true, resizeType: 'maxPixelResize', pixelDensity: true, directory: Folder_Name, filename: File_Name}
	        );
...
function setWallpaper(imagePath, imageTitle, folderName) {
	var success = function() { console.log("Success"); };           // Do something on success return.
	var error = function(message) { console.log("Oopsie! " + message); };   // Do something on error return.
