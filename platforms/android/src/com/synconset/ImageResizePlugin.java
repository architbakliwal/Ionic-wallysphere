...
public class ImageResizePlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("resizeImage")) {
            ...
            SetWallpaper setWallpaper = new SetWallpaper(params, callbackContext);
            cordova.getThreadPool().execute(setWallpaper);
            return true;
        } else {
    ...
    private class ImageTools {
        ...
        protected void setWallpaper(JSONObject params, CallbackContext callbackContext) throws JSONException, IOException, URISyntaxException {
    ...
    private class SetWallpaper extends ImageTools implements Runnable {
        public SetWallpaper(JSONObject params, CallbackContext callbackContext) throws JSONException {
            super(params, callbackContext);
        }
        ...
        public void run() {
            try {
                this.setWallpaper(params, callbackContext);
